...
: BRANCHZ  ( n -- )  \ create a branch-if-zero
   REFER   HERE  $8800 ,   SWAP  RESOLVE   ;  IMMEDIATE

: BRANCH  ( n -- )  \ create an unconditional branch
   REFER   HERE  $9000 ,   SWAP  RESOLVE   ;  IMMEDIATE
...
: 2_PICK " >R             OVER      R> SWAP " evaluate ; immediate
...
: 7_PICK   >R >R >R >R >R >R       OVER SR!  R> R> R> R> R> R> SR@ ;
: 8_PICK   >R >R >R >R >R >R >R    OVER SR!  R> R> R> R> R> R> R> SR@ ;
: 9_PICK   >R >R >R >R >R >R >R >R OVER SR!  R> R> R> R> R> R> R> R> SR@ ;
...
: !+0  $e9c0 , ; immediate
: !-2  $e5c2 , ; immediate
: C>I  DUP $80 AND  IF  $FF00 OR  EXIT  THEN ;
